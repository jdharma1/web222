...
function toggleLoading(isLoading) {
  if (isLoading == true) {
    ...
    //change the mag class to waiting icon
    document.getElementById("magnifyingIcon").class = "fas fa-hourglass-half";
    //change the search to loading text
    document.getElementById("searchText").innerHTML = "Loading...";
  } else {
    //disable the button.
    document.getElementById("submitButton").disabled = false;
    //change the mag class to waiting icon
    document.getElementById("magnifyingIcon").class = "fas fa-search";
    //change the search to loading text
